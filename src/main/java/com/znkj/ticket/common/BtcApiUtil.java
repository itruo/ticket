    ...
    public static List<Map<String, Object>> queryTradeValue(String btcAddr) {
        ...
        if (StringUtils.isNotBlank(btcAddr)) {
            try {
                ...
                log.error("【通过比特币api获取交易信息出错】【错误信息：{}】【】", e);
...
//                    resInfo = new String(data);
                    ...
                    log.info("【访问比特币api】【获取某地址交易信息】【请求连接失败】");
                }
            } catch (Exception e) {
                log.error("【访问比特币api】【获取某地址交易信息】【出现异常】{}", e);
            }
        }
        return resInfo;
    }
        ...
        if (StringUtils.isNotBlank(hash)) {
            ...
            try {
                ...
                if (200 == responseCode) {
                    ...
                    log.info("【访问比特币api】【根据交易hash查找该笔交易的确认次数】【请求连接失败】");
                }
            } catch (Exception e) {
                log.error("【访问比特币api】【根据交易hash查找该笔交易的确认次数】【出现异常】{}", e);
            }
        }
        return res;
    }
        ...
        if (StringUtils.isNotBlank(btcAddr)) {
            ...
            try {
                ...
                if (200 == responseCode) {
                    ...
                    log.info("【访问比特币api】【获取某地址账户信息】【请求连接失败】");
                }
            } catch (Exception e) {
                log.error("【访问比特币api】【获取某地址账户信息】【出现异常】{}", e);
            }
        }
        return resInfo;
    }
        ...
        if (StringUtils.isNotBlank(btcAddr)) {
            ...
            try {
                ...
                if (200 == responseCode) {
                    ...
                    log.info("【访问okcoin比特币api】【返回该比特币地址的交易信息】【请求连接失败】");
                }
            } catch (Exception e) {
                log.error("【访问okcoin比特币api】【返回该比特币地址的交易信息】【出现异常】{}", e);
            }
        }
        return resInfo;
    }
